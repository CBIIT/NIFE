...
function setup_biosample_table() {
  ...
  id_row.append("<td class='bio'> <input type='text'></input> </td>");
  ...
  description_row.append("<td class='bio'> <TEXTAREA> </TEXTAREA> </td>");
  table.append(description_row);
  var organism_row = $("<tr id='organism_row'>");
  organism_row.append("<th class='bio'> Organism </th>");
  organism_row.append("<td class='bio'> <SELECT><OPTION></OPTION><OPTION>Human</OPTION><OPTION>Dog</OPTION><SELECT> </td>");
  ...
  biosample_type_row.append("<td class='bio'> <SELECT><OPTION></OPTION><OPTION>Normal</OPTION><OPTION>Neoplasm</OPTION><SELECT> </td>");
  table.append(biosample_type_row);
  var cell_line_row = $("<tr id='cell_line_row'>");
  cell_line_row.append("<th class='bio'> Cell Line </th>");
  cell_line_row.append("<td class='bio'> <input type='text'></input> </td>");
  table.append(cell_line_row);
  var tissue_type_row = $("<tr id='tissue_type_row'>");
  tissue_type_row.append("<th class='bio'> Tissue Type </th>");
  tissue_type_row.append("<td class='bio'> <SELECT><OPTION></OPTION><OPTION>Normal</OPTION><OPTION>Neoplasm</OPTION><SELECT>  </td>");
  ...
  tissue_subtype_row.append("<td class='bio'> <SELECT><OPTION></OPTION><OPTION>Normal</OPTION><OPTION>Neoplasm</OPTION><SELECT>  </td>");
  ...
  intrinsic_variables_row.append("<td class='bio'> <input type='text'></input>  </td>");
  ...
  extrinsic_variables_row.append("<td class='bio'> <input type='text'></input>  </td>");
  ...
  experimental_variables_row.append("<td class='bio'> <input type='text'></input>  </td>");
